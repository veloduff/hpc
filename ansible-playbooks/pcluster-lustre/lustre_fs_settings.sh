...
fs_settings() {
    ...
    case "$fs_type" in
        ...
        "medium")
            # Default performance: 40K IOPS, 48TB capacity
            MDT_USE_LOCAL=false
            OST_USE_LOCAL=false
        ...
        "large")
            # Default performance: 80K IOPS, 96TB capacity
            MDT_USE_LOCAL=false
            OST_USE_LOCAL=false
        ...
        "xlarge")
            # Default performance: 160K IOPS, 96TB capacity
            MDT_USE_LOCAL=false
            OST_USE_LOCAL=false
        ...
        "local")
            # Default performance: will depend on Instance Store NVMe volumes 
            MDT_USE_LOCAL=true
            OST_USE_LOCAL=true
